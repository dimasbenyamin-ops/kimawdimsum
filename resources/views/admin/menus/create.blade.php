...
@section('title', 'Tambah Menu – Kumaw X Atmosphr Admin')
...
@section('content')
    <div class="page-header">
        <div>
            <h1>➕ Tambah Menu</h1>
            <p>Buat item menu dimsum baru</p>
        </div>
    ...
    <div class="form-card">
        <form method="POST" action="{{ route('admin.menus.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div style="font-size:0.8rem;color:var(--muted);margin-top:0.375rem">
                    Angka lebih kecil tampil lebih atas. Default: 100.
                </div>
            ...
            <div style="display:flex;gap:0.75rem;margin-top:0.5rem">
                <button type="submit" class="btn btn-gold" id="btn-save-menu">💾 Simpan Menu</button>
