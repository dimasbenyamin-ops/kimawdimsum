...
@section('title', 'Stock Opname – Kumaw X Atmosphr Admin')
...
@section('content')
    ...
    <div class="card">
        <div style="padding:1.5rem; border-bottom:1px solid var(--border)">
            <form method="GET" action="{{ route('admin.stock-opnames.index') }}" style="display:flex; gap:1rem; align-items:center; flex-wrap:wrap;">
