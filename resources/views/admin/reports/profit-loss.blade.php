...
@section('title', 'Laporan Laba Rugi – Kumaw Dimsum Admin')
...
@section('content')
    ...
    <div class="card" style="margin-bottom: 2rem;">
        <div style="padding:1.5rem;">
            <form method="GET" action="{{ route('admin.reports.profit-loss') }}" style="display:flex; gap:1rem; align-items:flex-end;">
                <div>
